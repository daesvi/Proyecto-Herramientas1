...
namespace GV
{
    ...
    public partial class PRODUCTOS : Form
    {
        ...
        private void PRODUCTOS_Load(object sender, EventArgs e)
        {
            ...
            p3.Hide();
            p4.Hide();
            cantidad1_label.Hide();
            cantidad2_label.Hide();
            cantidad3_label.Hide();
            cantidad4_label.Hide();
            cantidadmenos1_btn.Hide();
            cantidadmenos2_btn.Hide();
            cantidadmenos3_btn.Hide();
            cantidadmenos4_btn.Hide();
            cantidadmas1_btn.Hide();
            cantidadmas2_btn.Hide();
            cantidadmas3_btn.Hide();
            cantidadmas4_btn.Hide();
            agregar_btn.Hide();
            continuar_btn.Hide();
        }
        public void mostrar()
        {
            ...
            p3.Show();
            p4.Show();
            cantidad1_label.Show();
            cantidad2_label.Show();
            cantidad3_label.Show();
            cantidad4_label.Show();
            cantidadmenos1_btn.Show();
            cantidadmenos2_btn.Show();
            cantidadmenos3_btn.Show();
            cantidadmenos4_btn.Show();
            cantidadmas1_btn.Show();
            cantidadmas2_btn.Show();
            cantidadmas3_btn.Show();
            cantidadmas4_btn.Show();
            agregar_btn.Show();
            continuar_btn.Show();
        }
        ...
        private void agregar_btn_Click(object sender, EventArgs e)
        {
            if (productos_combobox.Text == "PLATOS")
            {
                if (nombreimg1.Checked == true && cantidad1_label.Text != Convert.ToString(0))
                {
                ...
                if (nombreimg2.Checked == true && cantidad2_label.Text != Convert.ToString(0))
                {
                ...
                if (nombreimg3.Checked == true && cantidad3_label.Text != Convert.ToString(0))
                {
                ...
                if (nombreimg4.Checked == true && cantidad4_label.Text != Convert.ToString(0))
                {
        ...
        private void Acerca_de_btn_Click(object sender, EventArgs e)
        {
